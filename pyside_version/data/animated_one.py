...
from pyside_version.data.TrimmablePainterPath import TrimmablePainterPath
...
class ToggleButton(QCheckBox):
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.setMinimumSize(50, 25)  # Set a minimum size for the button
        self.setMaximumSize(50, 25)  # Set a minimum size for the button
        ...
        self.borderWidth = 0.15  # Use a proportion instead of a fixed value
    ...
    def paintEvent(self, event: QPainter) -> None:
        ...
        pen = QPen()
        pen.setWidth(int(self.borderWidth * self.height()))  # Set border width dynamically
        ...
        x, y = pen.width() / 2, pen.width() / 2
        w, h = self.width() - pen.width(), self.height() - pen.width()  # Adjust width and height
